...
object Packages_EdFiExtensionsTemplate : Template({
    ...
    vcs {
        ...
        root(_Self.vcsRoots.OdsPlatform_EdFiExtensions, "+:Extensions/%extension.project% => Ed-Fi-Extensions/Extensions/%extension.project%", "+:LICENSE.txt => LICENSE.txt")
